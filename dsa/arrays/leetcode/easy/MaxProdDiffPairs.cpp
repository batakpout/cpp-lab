...
int maxProductDifferenceUsingSorting(vector<int>& nums) {
...
int main() {
    ...
    cout << "Using sorting: " << maxProductDifferenceUsingSorting(nums) << endl;
    cout << "Using single pass: " << singlePass(nums) << endl;
